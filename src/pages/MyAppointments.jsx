    ...
    <div>
      ...
      <div>
        {doctors.slice(0,3).map((item,index)=>(
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 birder-b' key={index}>
            <div>
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium'>Date and Time:</span> 25, July 2024 | 8:30 PM</p>
